...
def call_api(content, text_type="news", language="eng"):
...
def load_and_process_excel(input_excel, output_excel):
    ...
    for text_type in ['news', 'social']:
        for index, record in df.iterrows():
            ...
            combined_result = {**record, **headline_response, **text_response, 'TEXT_TYPE': text_type, 'LANGUAGE': 'eng'}
...
# Example usage
input_excel = 'C:\\temp\\paperradni\\COVID u Naslovu - EN.xlsx'  # Update with the path to your local Excel file
output_excel = 'C:\\temp\\paperradni\\COVID u Naslovu - EN - result_12_12.xlsx'  # Update with the path to save the output Excel file
